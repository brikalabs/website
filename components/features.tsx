...
function FeatureCard({
  ...
  visible,
  index,
}: Readonly<{ feature: Feature; visible: boolean; index: number }>) {
  ...
  return (
    <div
      ...
      style={visible ? { animationDelay: `${250 + index * 120}ms`, '--card-color': feature.color } as React.CSSProperties : undefined}
    ...
    >
      ...
      <div
        ...
        style={{ '--card-accent': `color-mix(in oklch, ${feature.color} 15%, transparent)` } as React.CSSProperties}
      />
      ...
      <div
        ...
        style={{ backgroundColor: `color-mix(in oklch, ${feature.color}, transparent 88%)` }}
      >
