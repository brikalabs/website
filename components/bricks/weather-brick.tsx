...
const iconMap: Record<WeatherIcon, React.ComponentType<{ className?: string; style?: React.CSSProperties }>> = {
  sun: Sun,
  cloud: Cloud,
  'cloud-fog': CloudFog,
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: theme.glow, filter: 'blur(24px)', opacity: 0.35 }}
      />
      {/* Weather icon */}
      <Icon
      ...
      />
      <div>
        <div className="text-[clamp(1.25rem,22%,1.5rem)] font-bold leading-tight tracking-tight">{temp}°C</div>
